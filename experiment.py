...
# Obtener los datos de la base de datos de spam

from src.Network import Network, g

alphas = [0.1, 0.01, 0.001]
hidden_layers = [[], [(57, 57)], [(57, 57), (57, 57)]]
...
for alpha, hidden_layer in configurations:
    ...
    network = Network(
        [(len(X[0]), 57), *hidden_layer, (57, 1)], 
        g, epsilon=0.0004,alpha=alpha)
    network.train(15000, X, Y)
    ...
    predictions_data.to_csv("spam_experiment_results.csv", index=False)
